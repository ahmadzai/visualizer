...
import { SettingRefComm } from './setting/';
...
$(document).ready(function () {
    ...
    */
    ...
    let  Setting = SettingRefComm;                          // Dynamic Setting as per loaded page
    ...
    apiCall.updateAll(url, Setting, filterData,
        {...filterData, loadWhat:'info'}); // passed mapFilter to set map data
