...
$(function () {
    ...
    // Pie charts Row
    config['recovered_all'] = {'color':['#40C97A', '#FFB32D']};
    config['recovered_absent'] = {'color':['#40C97A', '#FFFF00']};
    config['recovered_nss'] = {'color':['#40C97A', '#9C800E']};
    config['recovered_refusal'] = {'color':['#40C97A', '#FF0000']};
    ...
    config['missed_type_10camp'] = {'chart':{'type':"column", 'stacking':'normal'},
                                    'color':['#FFFF00', '#C99900', '#FF0000']};
    // 10 campaign absent percent chart
    config['ten_camp_absent'] = {'color': ['#EAFF19', '#40C97A'],
                                 'chart':{'type':"column", 'stacking':'percent'}
    };
    // 10 campaign nss percent chart
    config['ten_camp_nss'] = {'color': ['#9C800E', '#40C97A'],
        'chart':{'type':"column", 'stacking':'percent'}
    };
    // 10 campaign refusal percent chart
    config['ten_camp_refusal'] = {'color': ['#FF0000', '#40C97A'],
        'chart':{'type':"column", 'stacking':'percent'}};
    // 10 campaign absent column stack chart
    config['ten_camp_absent_normal'] = {'color': ['#EAFF19', '#40C97A'],
        'chart':{'type':"column", 'stacking':'normal'}
    };
    // 10 campaign nss column stack chart
    config['ten_camp_nss_normal'] = {'color': ['#9C800E', '#40C97A'],
                                     'chart':{'type':"column", 'stacking':'normal'}
    };
    // 10 campaign refusal column stack chart
